...
# Habría que cambiarla a la ubicacion real
	...
	$ArchivoTasas	= $DirectorioDeDatos."/cgi-bin/basesdatos/scsMontos.bd";
...
print "<h1 class='TitularSeccion'>Simulador de Préstamo - Nuevos Soles</h1>";
...
# #########################
   ...
   print "<p class='TextoNormal2'>Se ha solicitado un prestamo de S/. <b>$Prestamo</b><br>
